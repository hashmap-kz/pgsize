...
#
# pgsize install script
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/hashmap-kz/pgsize/master/scripts/install.sh | sh
#   
#   curl -fsSL https://raw.githubusercontent.com/hashmap-kz/pgsize/master/scripts/install.sh \
#    | PGSIZE_VERSION=v0.0.1 PGSIZE_INSTALL_DIR=/opt/pgsize/bin sh
#
#   wget -qO- https://raw.githubusercontent.com/hashmap-kz/pgsize/master/scripts/install.sh | sh
#
# Environment:
#   PGSIZE_VERSION       Release tag to install (default: latest)
#   PGSIZE_INSTALL_DIR   Install directory (default: /usr/local/bin, ignored on Windows)
#
# Requires: curl or wget, tar
#

REPO="hashmap-kz/pgsize"
BIN="pgsize"
...
if [ "$OS" = "windows" ]; then
    ...
    DEST="${PGSIZE_INSTALL_DIR:-/usr/local/bin}"
    BIN_FILE="$BIN"
